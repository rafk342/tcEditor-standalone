...
std::string INIReader::Get(const string& section, const string& name, const string& default_value) const
{
...
std::string INIReader::GetString(const string& section, const string& name, const string& default_value) const
{
...
std::string INIReader::MakeKey(const string& section, const string& name)
{
